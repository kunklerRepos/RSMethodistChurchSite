...
export default [
  ...
  },
  {
    id: 1,
    title: 'Bon Ami',
    start: new Date(2025, 8, 2, 18, 30, 0),
    end:   new Date(2025, 8, 2, 19, 30, 0),
  },
  {
    id: 2,
    title: 'Spaghetti Dinner',
    start: new Date(2025, 8, 5, 18, 0, 0),
    end:   new Date(2025, 8, 5, 20, 30, 0),
  },
  {
    id: 3,
    title: 'Navy Bean Festival - Float',
  ...
  {
    id: 4,
    title: 'Trustee & Admin Council',
    start: new Date(2025, 8, 15, 18, 30, 0),
    end:   new Date(2025, 8, 15, 20, 0, 0),
  },
  {
    id: 5,
    title: 'Worship at the River',
    start: new Date(2025, 8, 21, 10, 45, 0),
    end:   new Date(2025, 8, 21, 12, 0, 0),
  },
  {
    id: 6,
    title: 'Mission Trip',
